...
//                               1.0f, 2.0f, 1.0f };
    ...
    if (outImageCoord.x < width && outImageCoord.y < height/2)
    {
        //        int weight = 0;
        ...
        //            }
        //        }
        float4 readClr  = (float4)read_imagef(srcImg, sampler, outImageCoord );
        ...
        write_imagef(dstImg, outImageCoord,  (float4)outColor);
    }
